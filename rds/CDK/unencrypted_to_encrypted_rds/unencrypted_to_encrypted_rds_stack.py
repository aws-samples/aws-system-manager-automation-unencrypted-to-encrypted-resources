...
# The KMS key key should already exist to encrypt RDS Instances and Clusters
# Plesae ensure you have access to update KMS KMS key Resource policy
...
# You should delete a KMS key only when you are sure that you don't need to use it anymore. If you are not sure, consider disabling the KMS key instead of deleting it. You can reenable a disabled KMS key if you need to use it again later, but you cannot recover a deleted KMS key.
